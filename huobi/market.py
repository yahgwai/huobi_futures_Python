...
class Market:
    ...
    def __init__(self, platform=None, symbols=None, channels=None, orderbook_length=None, orderbooks_length=None,\
        ...
        if platform == const.HUOBI_SWAP:
            from huobi.platforms.huobi_swap_market import HuobiSwapMarket  as M
        elif platform == const.HUOBI_FUTURE:
            from huobi.platforms.huobi_future_market import HuobiFutureMarket  as M
        elif platform == const.HUOBI_OPTION:
            from huobi.platforms.huobi_option_market import HuobiOptionMarket  as M
        elif platform == const.HUOBI_USDT_SWAP:
            from huobi.platforms.huobi_usdt_swap_market import HuobiUsdtSwapMarket  as M
